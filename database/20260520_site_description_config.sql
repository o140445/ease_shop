...
VALUES (
  ...
  '',
  'text',
  'Shop Ease is a secure online store for curated electronics, home essentials and lifestyle products, with member pricing, balance payment and reliable after-sales service.',
  '',
  '',
  '',
  ''
