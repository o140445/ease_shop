...
(3,'basic','site_description','Site description','textarea','Shop Ease is a secure online store for curated electronics, home essentials and lifestyle products with member pricing and balance payment.',80,'normal',UNIX_TIMESTAMP(),UNIX_TIMESTAMP())
