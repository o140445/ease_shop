define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'shop.user.address/index' + location.search,
                    add_url: 'shop.user.address/add',
                    edit_url: 'shop.user.address/edit',
                    del_url: 'shop.user.address/del',
                    multi_url: 'shop.user.address/multi',
                    import_url: 'shop.user.address/import',
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'shop.user.address/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                sortOrder: 'desc',
                columns: [
